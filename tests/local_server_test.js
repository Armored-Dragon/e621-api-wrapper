...
const e621 = new (require(`../e621-api-wrapper`)).e621(`test`, {
  base_url: "", // Local server ip
  api_key: "", // Account (preferably admin) API Key
  username: "", // Account (preferably admin) Username
});
...
if (e621.base_url === "https://e621.net") {
  ...
  async function posts() {
    ...
    const postcreate_result = await e621.postsCreate(
      "./images/e621_api_wrapper_logo_(1.0.0).png",
      "please_delete test you_should_not_see_this delete_me",
      "e",
      "https://here.com/this.png"
    );
    ...
    await e621.postsUpdate(postcreate_result.data.post_id, {
      tag_string_diff: "-test new_tag_addition",
      edit_reason: "Because I said so",
      rating: "s",
      lock_rating: true,
      lock_notes: true,
      description: "This is the new description",
      source_diff: "https://notany.com/test.png -https://here.com/this.png",
    });
